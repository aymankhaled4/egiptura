...
const allPrograms = [...customPrograms, ...predefinedPrograms].filter(
  ...
  return (
    ...
    >
      {isModel && (
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#2a2b2e] flex items-center justify-center border border-[#C59D5F]/50">
        ...
        {message.content && (
          <div
            className={`rounded-2xl p-4 shadow-lg border border-[#C59D5F]/20 ${
              isModel
                ? 'bg-[#1b1c1e] text-gray-100 rounded-tl-none'
                : 'bg-[#2a2b2e] text-gray-100 rounded-br-none'
            }`}
          >
      ...
      {!isModel && (
        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#C59D5F]/20 flex items-center justify-center border border-[#C59D5F]/40">
